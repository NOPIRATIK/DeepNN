...
train_dataset = torchvision.datasets.ImageFolder(root='C:/Users/lexag/.spyder-py3/data',
                                                 transform=data_transforms)


# И отдельно создадим тестовый набор.
test_dataset = torchvision.datasets.ImageFolder(root='C:/Users/lexag/.spyder-py3/data/test',
                                             transform=data_transforms)
...
train_dataset = torchvision.datasets.ImageFolder(root='C:/Users/lexag/.spyder-py3/data/train',
                                                 transform=data_transforms)
test_dataset = torchvision.datasets.ImageFolder(root='C:/Users/lexag/.spyder-py3/data/test',
                                             transform=data_transforms)
...
# Задание (Алексей смог запустить с ноутбука, Алексей в шоке)
...
if __name__ == '__main__':
    ...
    train_dataset = torchvision.datasets.ImageFolder(root='C:/Users/lexag/.spyder-py3/data/train', transform=data_transforms)
    test_dataset = torchvision.datasets.ImageFolder(root='C:/Users/lexag/.spyder-py3/data/test', transform=data_transforms)
    ...
    # Сохранение модели
    torch.save(net.state_dict(), 'CnNet_AlexNet.ckpt')
